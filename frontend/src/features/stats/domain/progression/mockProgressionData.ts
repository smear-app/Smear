...
export const progressionMockData: Record<ProgressionRange, ProgressionViewModel> = {
  "10-weeks": {
    ...
    metrics: [
      { label: "Working Grade Change", value: "+0.6 V", description: "" },
      { label: "Working Grade", value: "V4.5", description: "" },
      { label: "Consistency", value: "3.2 / week", description: "" },
      { label: "Highest Grade", value: "V6", description: "" },
    ],
    milestones: [],
  },
  "6-months": {
    ...
    metrics: [
      { label: "Working Grade Change", value: "+1.0 V", description: "" },
      { label: "Working Grade", value: "V4.5", description: "" },
      { label: "Consistency", value: "3.0 / week", description: "" },
      { label: "Highest Grade", value: "V7", description: "" },
    ],
    milestones: [],
  },
  "all-time": {
    ...
    metrics: [
      { label: "Working Grade Change", value: "+2.2 V", description: "" },
      { label: "Working Grade", value: "V4", description: "" },
      { label: "Consistency", value: "2.8 / week", description: "" },
      { label: "Highest Grade", value: "V8", description: "" },
    ],
    milestones: [],
  },
}
