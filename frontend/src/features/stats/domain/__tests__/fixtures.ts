...
export function climb(overrides: Partial<EnrichedClimb> & Pick<EnrichedClimb, "id">): EnrichedClimb {
  ...
  return {
    ...
    sessionInsightLabel: overrides.sessionInsightLabel ?? null,
    sessionInsightReason: overrides.sessionInsightReason ?? null,
    sessionInsightClassifierVersion: overrides.sessionInsightClassifierVersion ?? null,
    loggedAt,
